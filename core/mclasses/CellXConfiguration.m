classdef CellXConfiguration < handle
    ...
    properties (GetAccess=public, SetAccess=private)
        ...
        % controls the probability threshold of cell being an
        % outlier. Takes values to [0,1]. The higher the value,
        % the higher the threshold, hence the stricteris for a
        % cell to be accepted as identified.  
        idPrecisionRate = 0.5;
...
%             end
        ...
        function setIdPrecisionRate(this, value)
                this.idPrecisionRate = value;
        end
